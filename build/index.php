			...
			<div class="resume-table">
				...
				<aside class="resume-column sidebar">
					<section class="sidebar-section">
						...
						<p>Always looking to hone my skills, currently learning frontend libraries like Angular in my
							free time. Interested in a position where I can bring my skills in leading development teams
							and providing expertise in custom WordPress themes and plugins. I thrive in collaborative
							environments and can help lead development efforts from kickoff to launch to client
							training.</p>
				...
				<div class="resume-column resume-column--right">
					...
					<section id="experience" class="resume-section">
						...
						<ul class="list list--experience">
							<li class="list-item">Planned/created WordPress sites, as a solo developer and as a team, from wireframes to
								development.</li>
							...
							<li class="list-item">Used modern pagespeed methods to optimize websites for high performance scores on Google
								Lighthouse audits.</li>
							<li class="list-item">Collaborated with SEO and Paid Media teams to plan websites that are highly visible to
								search engines.</li>
						</ul>
					...
					<section id="awards" class="resume-section">
						...
						<ul class="list list--columns list--awards">
							<li class="list-item"><a href="https://www.ustelecom.org/">USTelecom</a>, <em>Website Redesign 2019</em></li>
							...
							<li class="list-item"><a href="https://betterworldcampaign.org/">BetterWorldCampaign.org</a>, <em>2016</em>
							</li>
							...
							<li class="list-item"><a href="https://jewishfoodexperience.com/">JewishFoodExperience.com</a>, <em>2013</em>
							</li>
						</ul>
